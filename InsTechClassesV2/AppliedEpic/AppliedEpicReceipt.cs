...
{
   public class AppliedEpicReceipt
    {
        ...
        {
            [JsonConverter(typeof(Utility.SingleOrArrayConverter<CreditItem>))]
        ...
        public class CreditItem
        {
            ...
            // Epic sends booleans as strings
            public string? Pending { get; set; }

            // Can be string, int, or {}
        ...
        {
            public Boolean FullPayment{ get; set; }= true;
            public int ApplyToDebitTransactionID { get; set; }
        }
        ...
        public class Debits
        {
            [JsonConverter(typeof(Utility.SingleOrArrayConverter<DebitItem>))]
        ...
        public class ApplyDebitsToCreditsEnvelope
        {
            public ApplyDebitsToCreditsBody Body { get; set; }
        }

        public class ApplyDebitsToCreditsBody
        {
           public  GetGeneralLedgerApplyDebitsToCreditsReceiptResponse Get_GeneralLedger_ReceiptDefaultApplyCreditsToDebitsResponse { get; set; }
        }


        public class GetGeneralLedgerApplyDebitsToCreditsReceiptResponse
        {
           public Get_GeneralLedger_ReceiptDefaultApplyCreditsToDebitsResult Get_GeneralLedger_ReceiptDefaultApplyCreditsToDebitsResult { get; set; }
        }

        public class Get_GeneralLedger_ReceiptDefaultApplyCreditsToDebitsResult
        {
        ...
        public class ReceiptApplyDebitsToCreditsFilterResponse
        {
            public ApplyDebitsToCreditsEnvelope Envelope { get; set; }
        }
