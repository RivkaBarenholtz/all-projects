...
namespace InsTechClassesV2.Cardknox
{
   public class CardknoxTransactionReportResponse
    ...
    public class CardknoxReportItem
    {
        ...
        [JsonProperty("xBillFirstName")]
        public string BillFirstName { get; set; }
       [JsonProperty("xBillCompany")]
        public string BillCompany { get; set; }

        [JsonProperty("xStreet")]
        public string Street { get; set; }
        [JsonProperty("xBillCity")]
        public string BillCity { get; set; }
        [JsonProperty("xBillState")]
        public string BillState{ get; set; }
        [JsonProperty("xZip")]
        public string Zip { get; set; }
        [JsonProperty("xBillPhone")]
        ...
        public string Custom03 { get; set; }
         ...
         [JsonProperty("xCustom01")]
        public string Custom01 { get; set; }

        [JsonProperty("xCustom09")]
        public string Custom09 { get; set; }

        [JsonProperty("xCustom10")]
