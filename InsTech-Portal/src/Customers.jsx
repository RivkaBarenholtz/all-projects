...
import {NewCustomer} from "./Objects/NewCustomer";
...

{
   ...
   function ShowSuccessfulNewCustomer() {
      setShowNewCustomer(false);
      showSuccess("Successfully created new customer"  )
      getData()
   }
   return <>
   { customer !== null && <CustomerDetail customer={customer} onClose={()=>{setCustomer(null); getData(); }}/>}
      <div className="header">
          ...
          <div className="header-actions">
              ...
              <button className="btn btn-primary" type="button" onClick={()=> setShowNewCustomer(true)}>
                  <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {
         showNewCustomer && <NewCustomer Close={() => setShowNewCustomer(false)} OnSuccess={ShowSuccessfulNewCustomer} />
