    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ margin: "0 0 24px", fontSize: "11px", color: "#6b7280" }}>
            Complete the steps to set up recurring billing.
          </p>
            ...
            {currentStep === 4 && (
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                  ...
                  {/* Client */}
                  <div style={{ border: "1px solid #e5e7eb", borderRadius: "8px", padding: "16px", display: "flex", gap: "12px" }}>
                    <div style={{ width: "36px", height: "36px", borderRadius: "8px", background: "#ede9fe", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, fontSize: "18px" }}>👤</div>
                    <div>
                      <div style={{ fontSize: "10px", fontWeight: 700, color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "4px" }}>Client</div>
                      <div style={{ fontSize: "14px", fontWeight: 500 }}>{firstName} {lastName}</div>
                      <div style={{ fontSize: "12px", color: "#6b7280" }}>{company}{email ? ` · ${email}` : ""}</div>
                    </div>
                  </div>

                  {/* Payment */}
                  <div style={{ border: "1px solid #e5e7eb", borderRadius: "8px", padding: "16px", display: "flex", gap: "12px" }}>
                    <div style={{ width: "36px", height: "36px", borderRadius: "8px", background: "#fff7ed", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, fontSize: "18px" }}>💳</div>
                    <div>
                      <div style={{ fontSize: "10px", fontWeight: 700, color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "4px" }}>Payment Method</div>
                      <div style={{ fontSize: "14px", fontWeight: 500 }}>{activeTab === "Credit Card" ? "Credit Card" : "eCheck / ACH"}</div>
                    </div>
                  </div>
                  ...
                  <div style={{ border: "1px solid #e5e7eb", borderRadius: "8px", overflow: "hidden" }}>
                    <div style={{ padding: "16px", display: "flex", gap: "12px" }}>
                      <div style={{ width: "36px", height: "36px", borderRadius: "8px", background: "#f0fdf4", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, fontSize: "18px" }}>💲</div>
                      <div style={{ flex: 1 }}>
                        <div style={{ fontSize: "10px", fontWeight: 700, color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "8px" }}>Financials</div>
                        <div style={{ display: "flex", justifyContent: "space-between", fontSize: "12px", marginBottom: "4px" }}>
                          <span style={{ color: "#6b7280" }}>Base Amount</span>
                          <span style={{ fontWeight: 500 }}>{FormatCurrency(baseAmount)}</span>
                        </div>
                        {fee > 0 && (
                          <div style={{ display: "flex", justifyContent: "space-between", fontSize: "12px" }}>
                            <span style={{ color: "#6b7280" }}>Transfer Fee ({formData.transferFee}%)</span>
                            <span style={{ fontWeight: 500 }}>{FormatCurrency(fee)}</span>
                          </div>
                        )}
                      </div>
                    </div>
                    <div style={{ padding: "12px 16px", background: "#043969", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      ...
                      <span style={{ color: "white", fontSize: "18px", fontWeight: 700 }}>{FormatCurrency(total)}</span>
                    </div>
                  </div>

                  {/* Schedule */}
                  <div style={{ border: "1px solid #e5e7eb", borderRadius: "8px", padding: "16px", display: "flex", gap: "12px" }}>
                    <div style={{ width: "36px", height: "36px", borderRadius: "8px", background: "#eff6ff", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, fontSize: "18px" }}>📅</div>
                    <div>
                      <div style={{ fontSize: "10px", fontWeight: 700, color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "4px" }}>Schedule</div>
                      <div style={{ fontSize: "14px", fontWeight: 500 }}>{formData.scheduleName || "Unnamed Schedule"}</div>
                      <div style={{ fontSize: "12px", color: "#6b7280", marginTop: "4px" }}>
                        Every {formData.frequencyNum} {freqLabel}
                        {formData.startDate && ` · Starts ${formData.startDate}`}
                        {formData.endOption === "Never" && " · No end date"}
                        {formData.endOption === "Date" && formData.endDate && ` · Ends ${formData.endDate}`}
                        {formData.endOption === "NumberOfPayments" && ` · ${formData.numberOfPayments} payments`}
                      </div>
                    </div>
                  </div>
