...
import { PrintPDFButton, DownloadPDFButton, ReceiptButton } from "./PrintPdfButton";
...
export default function TransactionDetail({ transaction, onClose, getTransactions }) {
  ...
  return (
    <>
      {showEmailConfirm && <EmailModal close={() => { setShowEmailConfirm(false) }} transaction={transaction} />}
      <AnimatePresence>
        {transaction && (
